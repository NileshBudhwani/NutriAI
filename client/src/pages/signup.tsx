...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      toast({
        title: "Success",
        description: "Account created successfully! Welcome to NutriAI.",
      });
      setIsLoading(false);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 to-secondary/10 px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 text-primary text-2xl font-bold">
            <Leaf className="h-8 w-8" />
            NutriAI
          </Link>
          <p className="text-muted-foreground mt-2">Start your nutrition journey today</p>
        </div>

        <Card className="shadow-lg" data-testid="signup-card">
